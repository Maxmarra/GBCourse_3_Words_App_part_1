...
//There's also a keyword companion, meaning it's associated
// with the DetailActivity class,
// and we don't need to give it a separate type name.
    companion object{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // keeps a reference to the intent used to launch the activity
