...
import com.example.drillin_part_1_3.DetailActivity.Companion.SUFFIX_SEARCH
...
class WordAdapter(val letter:String, context: Context) : RecyclerView.Adapter<WordAdapter.WordViewHolder>() {
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            val query: Uri = Uri.parse("${SUFFIX_SEARCH}${word}${" " + context.resources.getString(R.string.translation)}")
